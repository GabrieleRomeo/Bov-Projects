...
document.addEventListener('DOMContentLoaded', function () {
      ...
      var signupForm  = document.getElementById('questionnaire');
      var doc         = document;
      var options     = doc.getElementsByName('option');

      var inputs = {
        otherValue: valid.getNode(doc.getElementById('otherValue'))
      }

      // Sets the change event for all the radio buttons
      var newObject = Object.keys(options).map(function(elem) {
          options[elem].addEventListener('change', function (event) {
      ...
      inputs.otherValue.node.addEventListener('change', function (event) {
