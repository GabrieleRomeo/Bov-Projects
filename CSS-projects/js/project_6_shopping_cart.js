    ...
    var Cart = (function(window) {
        ...
        var CartDB = {
            ...
            checkCoupon: function(coupon) {
              ...
              /*
               * It first checks if the coupon makes the total price less
               * than the total price with the current promo
               */
              ...
              // if the coupon saving is less then the normal saving,
              // it returns 0
         ...
         * quantity for products which are already in the shopping cart
         */
        ...
        var refreshCartSummary = function() {
            ...
            // Adds the amounts formatted with a currency in the
            // Shoppin Cart Table
        ...
        /*
         * The [getCurrency] function returns a price formatted with the
         * currency symbol which is saved in the database (dollar by default)
         */
        ...
        function currency(amount, separator) {
            ...
            if (len < 4) {
                ...
                return currency(remainder, separator) +
                       separator +
                       partial +
                       decimal;
            }
        ...
        /*
         * Given a value and a percentage, the [calcPercentage] function
         * calculatesthe resulting value
         */
        ...
        /*
         * This function is used for handling the remove event caught by a
         * remove button related to a particular product which is already in
         * the shopping cart
         *
         *       ^
         *       | [DOM EVENT BUBBLING]
        ...
        function removeEvent(evt) {
            if (evt.target !== evt.currentTarget) {
              ...
              // When the target event is not the same as the event listener
              // current target (which I set as the Table-cart Body element)

                var clickedItem = evt.target.id;
                // The id we are interested in, is of the form:
                // remove_Product-{N}
                var parts = clickedItem.split('_');

                if (parts[0] === 'remove') {
                    removeProduct(parts[1]); // parts[1] (the product's name)
                }
            }
            evt.stopPropagation(); // It stops the bubbling
        }
       ...
       *******************************************************/
         ...
         * arguments, and returns the first element of the Array (or the element
         * at the provided index, if any). If the provided index is out of range,
         * it returns the entire Array. If the first argument is not an Array,
         * it returns the first argument provided to the function.
         *
         */
         ...
         * If the provided index is out of range, it behaves just as the same
         * as if the optional index had not been provided.
         */
         ...
         * arguments, and returns a new Array which does not contain the
         * unwanted elements. If the first argument is not an Array, it returns
         ...
         * It maps each table's object and for each entry, it applies the
         * Utility pick function for extracting the desired keys.
         ...
         *
         * The result of fSelect is an Array of objects containing only the
         * desired properties
         */
         ...
         * reduces the list. It returns a new partial 'table' Array everytime
         * the predicate is true, otherwise it removes the current object from
         * the resulting 'table'
         */
